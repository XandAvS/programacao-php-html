    ...
    <div class="row">
        <div class="col-3 mx-auto">
            ...
            <form method="post" action="ativ<?php echo $exercicio_atual; ?>resposta.php">
                <div class="mb-3">
                    <label for="valor 1" class="form-label">1° Informe o produto a ser cadastrado</label>
                    <input type="text" id="nome_produto" name="nome_produto" class="form-control" required="" placeholder="Novo Produto">
                </div>
                <div class="mb-3">
                    <label for="valor2" class="form-label">2° Informe o preço do produto R$</label>
                    <input type="number" step="0.01" id="preco" name="preco" class="form-control" required="" placeholder="R$: 0.00">
                </div>
