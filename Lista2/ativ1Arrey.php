        ...
        <div class="col-3 mx-auto">
            ...
            <!-- quero fazer uma repetição para que não fique 7 
             ...
             <form method="post" action="ativ<?php echo $exercicio_atual; ?>resposta.php">
                ...
                <div class="mb-3">
                    <label for="valor2" class="form-label">2° Informe o segundo valor</label>
                    <input type="number" id="valor2" name="valor2" class="form-control" required="">
                </div>
                <div class="mb-3">
                    <label for="valor 1" class="form-label">3° Informe o terceiro valor</label>
                    <input type="number" id="valor1" name="valor3" class="form-control" required="">
                </div>
                <div class="mb-3">
                    <label for="valor2" class="form-label">4° Informe o quarto valor</label>
                    <input type="number" id="valor2" name="valor4" class="form-control" required="">
                </div>
                <div class="mb-3">
                    <label for="valor 1" class="form-label">5° Informe o quinto valor</label>
                    <input type="number" id="valor1" name="valor5" class="form-control" required="">
                </div>
                <div class="mb-3">
                    <label for="valor2" class="form-label">6° Informe o sexto valor</label>
                    <input type="number" id="valor2" name="valor6" class="form-control" required="">
                </div>
                <div class="mb-3">
                    <label for="valor 1" class="form-label">7° Informe o setimo valor</label>
                    <input type="number" id="valor1" name="valor7" class="form-control" required="">
                </div>
