...
<body>
    ...
    <div class="row">
        <form method="post" action="">
            ...
            <h2 class="text-center">Exercício <?php echo $exercicio_atual; ?> Cadastro-Produtos</h2>
                <?php for ($i = 0; $i < 5; $i++): ?>
                    <div class="col-md-2 mb-3">
                        <div class="border p-3 rounded shadow-sm">
                            <label>Código do Produto <?php echo $i + 1; ?>:</label>
            ...
            try {
                ...
                for ($i = 0; $i < 5; $i++) {
                    ...
                    if (isset($produtos[$codigo])) {
                        echo "<p class='text-danger'>Produto com código <strong>$codigo</strong> já inserido! Ignorado.</p>";
                        continue;
                    }

                    if ($preco > 100) {
                        $preco *= 0.90; // Aplicar 10% de desconto
                    }

                    $produtos[$codigo] = ['nome' => $nome, 'preco' => round($preco, 2)];
                }
                ...
                echo "<h4>Lista de Produtos (ordenada por nome):</h4>";
                echo "<ul class='list-group'>";
                foreach ($produtos as $codigo => $dados) {
                    echo "<li class='list-group-item d-flex justify-content-between align-items-center'>
                    <span>{$dados['nome']} (Código: $codigo)</span>
