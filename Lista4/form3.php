    ...
    <div class="row">
        <div class="col-3 mx-auto">
            ...
            <form method="post" action="form<?php echo $exercicio_atual; ?>resposta.php">
                <div class="mb-3">
                    <label for="valor 1" class="form-label">Informe Primeiro Texto</label>
                    <input type="text" id="valor1" name="valor1" class="form-control" required="">
                </div>
                <div class="mb-3">
                    <label for="valor 1" class="form-label">Informe Segundo Texto</label>
                    <input type="text" id="valor1" name="valor2" class="form-control" required="">
                </div>
