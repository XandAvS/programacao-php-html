        ...
        <div class="col-3 mx-auto">
            ...
            <?php
                function ehDataValida($d, $m, $a) {
                    $anoAtual = date('Y');
                    if ($d < 1 || $d > 31 || $m < 1 || $m > 12 || $a > $anoAtual) return false;
                    if ($m == 2) {
                        $bissexto = ($a % 4 == 0 && $a % 100 != 0) || ($a % 400 == 0);
                        return $d <= ($bissexto ? 29 : 28);
                    }
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                try {
                    ...
                    if (ehDataValida($d, $m, $a)) {
                        echo "Data válida: " . sprintf("%02d/%02d/%04d", $d, $m, $a);
                    } else {
                        echo "Data inválida! Verifique o dia, mês ou ano (não pode ser maior que o atual).";
                    }
                } catch (Exception $e) {
                    echo $e->getMessage();
                }
